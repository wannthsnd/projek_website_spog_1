@extends('layouts.app')
@section('title', 'Edit UPT - ' . $upt->name)
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50/40 to-teal-50/30 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300 py-6 sm:py-8">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 dark:text-slate-400 text-sm">{{ $upt->name }}</p>
                    </div>
                </div>

                <!-- Status Badge -->
                <span class="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 bg-amber-100/80 dark:bg-amber-900/40 text-amber-700 dark:text-amber-300 text-xs font-medium rounded-lg border border-amber-200/60 dark:border-amber-700/60">
        ...
        <!-- Form -->
        <form action="{{ route('super-admin.upts.update', $upt->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-700/60 p-5 sm:p-6 hover:shadow-md transition-shadow duration-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $upt->name) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code', $upt->code) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="region" value="{{ old('region', $upt->region) }}" required
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="alamat" rows="3"
                                  ...
                                  placeholder="Jl. Yos Sudarso Panjang...">{{ old('alamat', $upt->alamat) }}</textarea>
                        @error('alamat')
                            <p class="text-red-500 text-xs mt-1.5 flex items-center gap-1">
                                <i class="bi bi-exclamation-circle"></i> {{ $message }}
                            </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="kota" value="{{ old('kota', $upt->kota) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_pos" value="{{ old('kode_pos', $upt->kode_pos) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="telepon" value="{{ old('telepon', $upt->telepon) }}"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $upt->email) }}"
                        ...
                        <div>
                            ...
                            <input type="url" name="website" value="{{ old('website', $upt->website) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="tgm" value="{{ old('tgm', $upt->tgm) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="tlx" value="{{ old('tlx', $upt->tlx) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="fax" value="{{ old('fax', $upt->fax) }}"
            ...
            <div class="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-700/60 p-5 sm:p-6 hover:shadow-md transition-shadow duration-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="kepala_kantor" value="{{ old('kepala_kantor', $upt->kepala_kantor) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nip_kepala" value="{{ old('nip_kepala', $upt->nip_kepala) }}"
            ...
            <div class="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200/60 dark:border-slate-700/60 p-5 sm:p-6 hover:shadow-md transition-shadow duration-200">
                ...
                <label class="flex items-center gap-3 cursor-pointer group">
                    <div class="relative">
                        <input type="checkbox" name="is_active" value="1" id="is_active" {{ old('is_active', $upt->is_active) ? 'checked' : '' }}
                               class="sr-only peer">
